...
from mlfinlab.data_structures_snapshot_tick.base_bars import BaseImbalanceBars
...
class EMAImbalanceBars(BaseImbalanceBars):
    ...
    def _get_exp_num_ticks(self):
        ...
        # print("get_exp_num_ticks",prev_num_of_ticks[-self.num_prev_bars:],
        #       min(max(exp_num_ticks, self.min_exp_num_ticks), self.max_exp_num_ticks))
